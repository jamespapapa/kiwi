...
PHASE5_TEST_ENV_OVERRIDES = {
    "api_base_url": "KIWI_PHASE5_TEST_API_BASE_URL",
    "coder_api_base_url": "KIWI_PHASE5_TEST_CODER_API_BASE_URL",
    "orchestrator_model": "KIWI_PHASE5_TEST_ORCHESTRATOR_MODEL",
    "coder_model": "KIWI_PHASE5_TEST_CODER_MODEL",
}
...
def get_internal_settings() -> InternalSettings:
    data = dict(DEFAULTS)
    if os.getenv("KIWI_PHASE5_TEST_MODE") == "1":
        for key, env_name in PHASE5_TEST_ENV_OVERRIDES.items():
