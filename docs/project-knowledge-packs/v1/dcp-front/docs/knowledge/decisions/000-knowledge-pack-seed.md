...
Use this pack as a starting context for `dcp-front`. Do not treat seed evidence as target-project truth after installation; verify every claim against current files.
