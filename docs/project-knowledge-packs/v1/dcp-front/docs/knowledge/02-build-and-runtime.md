...
DCP Vue 2 front-end knowledge seed for route/view/Vuex DataStore/API/CSS/browser verification work.

## Verification/Build Commands

- Use the narrowest lint/build/Playwright/DOM fallback documented in the target repo.
