...
- Do not expose personal data in UI/logs.
- Trace auth/session redirects and system-block handling before frontend changes.
- Do not modify global interceptors without explicit scope.
