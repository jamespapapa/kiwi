...
- DRT: direct customer insurance channel.
- DrtHttpClient: shared Axios wrapper.
- Pinia store: client state carrier.
- System block: global maintenance/block response handling.
