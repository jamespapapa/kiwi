...
- Frontend service model files define admin field metadata.
- Backend generated domain/support classes and MyBatis XML define persistence shape.
- `erd/**` and `genie-sql/**` are seed references, not automatic migration authority.
