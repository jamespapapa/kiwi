...
Maven parent, Java 17, Spring Boot 3, MyBatis/Dynamic SQL, Redis/session, WebFlux/WebSocket, Quasar, Vue 3, TypeScript, Pinia, Axios, ag-grid, Cypress.
