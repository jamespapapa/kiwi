...
- CMS: DRT admin application.
- Resource: backend REST controller.
- Quasar view: admin screen.
- ag-grid: shared admin table/grid behavior.
- Generated domain/DSL: regeneration-sensitive backend model.
