...
profile: "drt-cms"
title: "06-frontend-css-and-dom"
source_reference: "../ref/drt-cms-main"
copy_mode: "seed; verify and replace evidence in the target project"
---

# Frontend CSS And DOM

## Frontend Notes

- Identify scoped vs global style location before edits.
- Trace containing block, selector specificity, and shared component usage.
- Use DOM/text/CSS checks and screenshot path for human visual confirmation.
