...
- Frontend Axios/admin API.
- Backend Redis/session/security/WebSocket/WebFlux.
- CTI static resources.
- Firo/file/excel/batch utilities.
- EAI modules under embd/pd where present.
