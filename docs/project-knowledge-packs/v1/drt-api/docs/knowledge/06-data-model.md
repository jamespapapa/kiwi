...
- Java model/DTO classes and MyBatis XML define request/response/persistence shapes.
- Mapper parameter names, XML ids, and response wrappers must be checked together.
