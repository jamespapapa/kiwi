...
title: "knowledge pack seed decision"
...
# Decision: v1 Knowledge Pack Seed

Use this pack as a starting context for `dcp-services`. Do not treat seed evidence as target-project truth after installation; verify every claim against current files.
