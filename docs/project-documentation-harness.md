...
이 문서는 폐쇄망 안에서 Qwen3.5-397B가 단독으로, 또는 `qwencode ultrawork` 멀티에이전트로 대형 프로젝트를 면밀히 분석하고 장기 활용 가능한 문서를 작성하기 위한 표준 하네스다.
...
- 반복 탐색을 통제한다. 같은 파일을 이유 없이 계속 읽지 말고, 파일별 읽은 목적과 요약을 `D:/aiops/docs/<project-key>/knowledge/_worklog.md`에 남긴다.
...
Qwen3.5-397B 단독으로도 실행할 수 있지만, 결과 품질은 `ultrawork` 멀티에이전트 방식이 유리하다.
...
- explorer-35: read-only 탐색을 담당한다. `rg`, `rg --files`, `find`, `sed`, `nl`, build descriptor 확인을 수행하며 독립 질문은 최대 5개까지 병렬 호출할 수 있다.
...
- 문서 작성 대상 디렉터리를 만든다.
- `D:/aiops/docs/<project-key>/knowledge/_worklog.md`를 만들고 phase, 질문, 읽은 파일, 결론, 다음 작업을 기록한다.
...
- `D:/aiops/docs/<project-key>/knowledge/_worklog.md`
- `D:/aiops/docs/<project-key>/knowledge/00-index.md` 초안
- `D:/aiops/docs/<project-key>/knowledge/99-gaps-and-questions.md` 초안
...
- `D:/aiops/docs/<project-key>/knowledge/01-repository-map.md`
- `D:/aiops/docs/<project-key>/knowledge/02-build-and-runtime.md`
- `D:/aiops/docs/<project-key>/knowledge/modules/<module-or-area>.md` 초안
...
- `D:/aiops/docs/<project-key>/knowledge/02-build-and-runtime.md`
- `D:/aiops/docs/<project-key>/knowledge/10-testing-and-quality.md`
- `D:/aiops/docs/<project-key>/knowledge/11-operations-and-deployment.md`
...
- `D:/aiops/docs/<project-key>/knowledge/03-system-boundaries.md`
- `D:/aiops/docs/<project-key>/knowledge/modules/*.md`
...
- `D:/aiops/docs/<project-key>/knowledge/04-domain-glossary.md`
- `D:/aiops/docs/<project-key>/knowledge/flows/<flow-name>.md`
- `D:/aiops/docs/<project-key>/knowledge/07-state-and-data-propagation.md`
...
- `D:/aiops/docs/<project-key>/knowledge/06-frontend-css-and-dom.md`
- `D:/aiops/docs/<project-key>/knowledge/playbooks/frontend-css-safe-change.md`
...
- `D:/aiops/docs/<project-key>/knowledge/05-api-and-contracts.md`
- `D:/aiops/docs/<project-key>/knowledge/apis/*.md`
- `D:/aiops/docs/<project-key>/knowledge/08-integrations.md`
...
- `D:/aiops/docs/<project-key>/knowledge/07-state-and-data-propagation.md`
- `D:/aiops/docs/<project-key>/knowledge/data/*.md`
...
- `D:/aiops/docs/<project-key>/knowledge/09-security-auth-privacy.md`
...
- `D:/aiops/docs/<project-key>/knowledge/12-change-playbooks.md`
...
- `D:/aiops/docs/<project-key>/knowledge/99-gaps-and-questions.md`
- 갱신된 `D:/aiops/docs/<project-key>/knowledge/00-index.md`
- 갱신된 `KIWI.md`
