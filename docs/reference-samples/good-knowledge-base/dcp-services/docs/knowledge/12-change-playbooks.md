...
5. Add or update an API document under `D:/aiops/docs/<project-key>/knowledge/apis/`.
...
6. Add module doc under `D:/aiops/docs/<project-key>/knowledge/modules/<module>.md`.
